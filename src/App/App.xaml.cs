    ...
    private async void RunShot(string[] args)
    {
        ...
        try
        {
            ...
            if (entry != null)
            {
                ...
                // Optional 4th arg: permutation/variant index. Optional 5th arg: material view name.
                ...
                if (args.Length >= 5 && Enum.TryParse<Services.MaterialView>(args[4], true, out var mv))
                {
